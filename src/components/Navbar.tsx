...
const Navbar = () => {
	...
	return (
		<header className="fixed top-0 left-0 right-0 z-50 flex flex-row items-center justify-between px-4 md:px-20 py-4 border-b border-white/10">
			...
			<button
				ref={buttonRef}
				className="md:hidden text-white p-2 w-12 h-12 flex items-center justify-center"
			...
			<div
				...
				} fixed top-[72px] right-0 h-auto bg-gray-900/95 backdrop-blur-sm transition-transform duration-300 ease-in-out md:hidden w-full`}
			>
				<nav className="flex flex-col items-center gap-4 p-4">
					...
					<a
						...
						onClick={() => setIsMenuOpen(false)}
					>
						<span className="bg-blue-500/20 px-4 py-2	rounded-2xl hover:bg-blue-500/40  transition-all ease-in-out duration-50">
